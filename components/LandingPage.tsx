    ...
    <>
      ...
      <div className="relative bg-[#174826] ">
        ...
        <SectionsInViewMotion>
          <OurServicesGrid sectionRef={ctaRef} />
        </SectionsInViewMotion>
        ...
        <footer id="contact" className="relative z-10 flex min-h-[60vh] scroll-mt-24 flex-col justify-end gap-14 bg-linear-to-b from-black 60% to-[#19532B] py-8 sm:gap-20 sm:py-12">
          <div className="w-full text-center space-y-8 text-cream/60">
            ...
            <div className="relative flex w-full flex-col items-center justify-between gap-6 px-4 sm:flex-row sm:gap-4">
              ...
              <div className="flex [&>a]:hover:text-[#ff7c24] [&>a]:px-8 gap-6 sm:gap-10"><a href="https://www.instagram.com/producedbylucid" className="transition-colors ">Instagram</a>  <a href="#" className="transition-colors hover:text-[#FFE1CD]">LinkedIn</a> <a href="#" className="transition-colors hover:text-[#FFE1CD]">X</a></div>
            </div>
            <p className="w-full px-6 py-5 text-center text-sm opacity-70 duration-200 hover:opacity-100 sm:text-right sm:text-base">&copy; 2026 Produced by Lucid. All rights reserved.</p>
          </div>
        </footer>
      </div>
    </>
