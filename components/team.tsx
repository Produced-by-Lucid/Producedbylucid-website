    ...
    return (
        <section className='min-h-screen bg-white relative max-sm:min-h-[100svh] max-sm:overflow-hidden max-sm:py-12'>
            <div>
                ...
                <div className="flex items-center justify-between flex-col gap-18 max-sm:gap-8">
                    ...
                    <div className="grid relative z-2 grid-cols-2 sm:grid-cols-3 gap-12 max-sm:w-full max-sm:gap-4 max-sm:px-4">
                        {team.members.map((member) => (
                            <div key={member.name} className="rounded-full bg-[#ebe9e8] overflow-hidden group relative hover:scale-110 duration-300 ease-in-out cursor-pointer aspect-square size-80 max-sm:size-auto max-sm:w-full max-sm:hover:scale-100">
                                ...
                                />
                                <div className="rounded-full flex items-center justify-center text-center flex-col ease-in group-hover:scale-120 bg-[#db612d]/80 backdrop-blur-md absolute translate-y-[100%] group-hover:translate-y-0 duration-75 left-0 m-auto z-3 top-0 aspect-square size-80 max-sm:size-full max-sm:translate-y-0 max-sm:justify-end max-sm:pb-5 max-sm:group-hover:scale-100">
